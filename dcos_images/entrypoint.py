...
if __name__ == '__main__':
    ...
    if not args or args[0].startswith('-'):
        ...
        args.insert(0, '/usr/local/bin/pypi-server')
    ...
    # Executing squid-deb-proxy
    print("---------------------------------------------------------------")
    print("=> Initializing squid-deb-proxy")
    print("---------------------------------------------------------------")
    os.system("service squid-deb-proxy start")
    os.system("tail -f /var/log/squid-deb-proxy/access.log /var/log/squid-deb-proxy/cache.log "
              "/var/log/squid-deb-proxy/store.log &")

    print("---------------------------------------------------------------")
    print("=> Initializing pypi-server")
    print("---------------------------------------------------------------")
    print("Executable: " + executable + "  Args: " + str(args))
